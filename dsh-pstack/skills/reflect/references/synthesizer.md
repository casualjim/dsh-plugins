...
- "skill-bundled scripts run under the local runtime with their own lockfile, not the pnpm workspace"
- "path-shaped triggers belong in skill metadata, not description prose"
...
| <new pattern, no existing skill is a real home> | <draft a new skill in the DSH SKILL.md format> | <new skill: <kebab-name>> |
