...
- Confidence: candidate
- Skip when: Bugbot flags an export, component, helper, or file as unused, and the upper-stack diffs (`git diff base..tip` on the stacked branches) or PR context shows it is used by a later PR in the stack.
